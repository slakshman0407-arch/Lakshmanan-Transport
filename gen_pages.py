...
<body>
    <header class="navbar" id="navbar">
        <div class="container nav-container">
            ...
            <div class="header-contact">
                ...
                <a href="https://wa.me/919962603684" class="btn btn-primary nav-cta" style="background:#25d366; color:#fff; border:none;"><i class='bx bxl-whatsapp' style='font-size:1.4rem; margin-right:5px;'></i> WhatsApp</a>
            </div>
        ...
        <div class="container footer-container">
            <div class="footer-brand">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.instagram.com/lakshmanan_transport_004/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><i class='bx bxl-instagram'></i></a>
                </div>
            </div>
    ...
    <a href="https://wa.me/919962603684" class="whatsapp-float" target="_blank">
